...
// Command-line arguments: test /Users/luyihan/Desktop/AutoVeri/trans_output/trans.dfy --no-verify --standard-libraries
// the_program
...
method {:test} check()
{
  var call0 := prime_num(-10);
  var call1 := prime_num(0);
  var call2 := prime_num(10);
  var call3 := prime_num(13);
  var call4 := prime_num(17);
  var call5 := prime_num(100);
  expect call0 == false, ""expectation violation"";
  expect call1 == false, ""expectation violation"";
  expect call2 == false, ""expectation violation"";
  expect call3 == true, ""expectation violation"";
  expect call4 == true, ""expectation violation"";
  expect call5 == false, ""expectation violation"";
}
...
namespace _module {
  ...
  public partial class __default {
    public static bool prime__num(BigInteger num)
    {
      bool result = false;
      if ((num) >= (BigInteger.One)) {
        BigInteger _0_i;
        _0_i = new BigInteger(2);
        while ((_0_i) < ((Dafny.Helpers.EuclideanDivision(num, new BigInteger(2))) + (BigInteger.One))) {
          if ((Dafny.Helpers.EuclideanModulus(num, _0_i)).Sign == 0) {
            result = false;
            return result;
          }
    ...
    public static void check()
    {
      bool _0_call0;
      bool _out0;
      _out0 = __default.prime__num(new BigInteger(-10));
      _0_call0 = _out0;
      bool _1_call1;
      bool _out1;
      _out1 = __default.prime__num(BigInteger.Zero);
      _1_call1 = _out1;
      bool _2_call2;
      bool _out2;
      _out2 = __default.prime__num(new BigInteger(10));
      _2_call2 = _out2;
      bool _3_call3;
      bool _out3;
      _out3 = __default.prime__num(new BigInteger(13));
      _3_call3 = _out3;
      bool _4_call4;
      bool _out4;
      _out4 = __default.prime__num(new BigInteger(17));
      _4_call4 = _out4;
      bool _5_call5;
      bool _out5;
      _out5 = __default.prime__num(new BigInteger(100));
      _5_call5 = _out5;
      if (!((_0_call0) == (false))) {
        throw new Dafny.HaltException("trans_output/trans.dfy(34,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((_1_call1) == (false))) {
        throw new Dafny.HaltException("trans_output/trans.dfy(35,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((_2_call2) == (false))) {
        throw new Dafny.HaltException("trans_output/trans.dfy(36,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((_3_call3) == (true))) {
        throw new Dafny.HaltException("trans_output/trans.dfy(37,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((_4_call4) == (true))) {
        throw new Dafny.HaltException("trans_output/trans.dfy(38,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((_5_call5) == (false))) {
        throw new Dafny.HaltException("trans_output/trans.dfy(39,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
...
")).ToVerbatimString(false));
      ...
      if (!(_0_success)) {
        throw new Dafny.HaltException("trans_output/trans.dfy(1,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test failures occurred: see above.
").ToVerbatimString(false));}
    }
  }
