...
def process_folder(folderPath, user_labels_json_file):
    ...
    output_path = '/Users/luyihan/Desktop/AutoVeri/speceval_output'
    ...
    for file in files:
        ...
        dafny_binary = '/opt/homebrew/bin/dafny'
        # create a logfile  in now_str folder
        log_file = file + '.dmp.txt'
        print('Processing file', fullpath)
        subprocess.run(
            ['python3', '/Users/luyihan/Desktop/AutoVeri/spec_evaluation/mutation_test/eval_dafny_spec.py', 
    ...
    subprocess.run(['python3', '/Users/luyihan/Desktop/AutoVeri/spec_evaluation/mutation_test/extract.py'])

def main():
    args = parser.parse_args()
    folderPath = '/Users/luyihan/Desktop/AutoVeri/specgen_output'
